...
const UserDetails = ({
  ...
  return (
    <>
      ...
      >
        <TabsButton text="Posts" activeTab={activeTab} setActiveTab={setActiveTab} />
        <TabsButton text="Videos" activeTab={activeTab} setActiveTab={setActiveTab} />
      </View>
...
const TabsButton = ({ text, activeTab, setActiveTab }) => (
  <View style={{width: "45%"}}>
    <TouchableOpacity
      style={{
        backgroundColor: activeTab === text ? "white" : 0,
        borderRadius: 30,
        overflow: "hidden",
      }}
    ...
    >
      <Text
        style={{
          color: activeTab === text ? "black" : "white",
          textAlign: "center",
          fontSize: 17,
          fontWeight: "bold",
          padding: 7,
