...
export default function LikesModal({ setModalVisible, navigation, postLikes }) {
    ...
    <View style={styles.modalContainer}>
      ...
      <ImageBackground
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Likes navigation={navigation} setModalVisible={setModalVisible} userProfiles={userProfiles}/>
        </ScrollView>
        </View>
        </ImageBackground>
      </View>
