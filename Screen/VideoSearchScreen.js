...
export default function VideoSearchScreen({ navigation }) {
  ...
  useEffect(() => {
    ...
    fetch(`https://darkvilla.onrender.com/api/video/search/${query}`, {
      headers: {
...
const Header = ({ navigation }) => (
  <View style={styles.headerContainer}>
    ...
    <Text style={styles.headerText}>Search Video</Text>
    <Text></Text>
  </View>
);
